...
function selectedCharacter(value){
    ...
    imageCharacterHTML += '<div class="img-wrapper">' +
        ...
        '" alt="Image 4" class="draggable-image">' + '</div>';
    
    imageCharacterHTML += '<div class="data-container" id="dataC">'+
    '<h1 id="title" class="title">' + data[value]['title'] + '</h1>'+
    '<h1 id="name">' + data[value]['name'] + '</h1>';

    imageCharacterHTML += '<div class="class-element" id="other-data">'+
    '<img id="rarity"' + 'src="' + data[value]['rarity'] + '">'+
    '<img id="element"' + 'src="' + data[value]['element'] + '">'+
    '<img id="classs"' + 'src="' + data[value]['class'] + '">'+
    '<img id="type"' + 'src="' + data[value]['type'] + '"></div>';

    imageCharacterHTML += '<div class="history" id="history">'+
    '<h1>' + data[value]['history'] + '</h1></div></div></div>';

    navbar.innerHTML = characterHTML;
    imageCharacter.innerHTML = imageCharacterHTML;
}
